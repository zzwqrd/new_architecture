...
class StylesApp {
  ...
  final mainColorButton = const Color(0xFF34C759);
  final mainColorText = const Color(0xFF006519);
  final mainColorLabel = const Color(0xFFB1BEA5);
  final mainColorAd = const Color(0xFF99CC82);
  final mainColorBorder = const Color(0xFFE8E8E8);
